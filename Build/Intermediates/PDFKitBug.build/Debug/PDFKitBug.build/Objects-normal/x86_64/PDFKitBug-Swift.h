...
SWIFT_CLASS("_TtC9PDFKitBug11AppDelegate")
...
SWIFT_CLASS("_TtC9PDFKitBug14ViewController")
@interface ViewController : NSViewController
@property (nonatomic, weak) IBOutlet PDFView * _Null_unspecified pdfView;
@property (nonatomic, weak) IBOutlet NSButton * _Null_unspecified button;
@property (nonatomic, strong) PDFDocument * _Nullable pdf;
@property (nonatomic, strong) PDFPage * _Nullable pdfPage;
- (void)viewDidLoad;
@property (nonatomic) id _Nullable representedObject;
- (IBAction)addAnnotation:(id _Nonnull)sender;
